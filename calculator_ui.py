...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.eqt = QtWidgets.QLabel(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.eqt.sizePolicy().hasHeightForWidth())
        self.eqt.setSizePolicy(sizePolicy)
        self.eqt.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(12)
        font.setKerning(True)
        self.eqt.setFont(font)
        self.eqt.setFrameShape(QtWidgets.QFrame.Box)
        self.eqt.setFrameShadow(QtWidgets.QFrame.Raised)
        self.eqt.setLineWidth(0)
        self.eqt.setText("")
        self.eqt.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.eqt.setWordWrap(False)
        self.eqt.setIndent(12)
        self.eqt.setObjectName("eqt")
        self.num = QtWidgets.QLabel(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
