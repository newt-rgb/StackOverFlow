...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.addtodo.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/tianjia.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addtodo.setIcon(icon)
        self.addtodo.setIconSize(QtCore.QSize(80, 80))
        self.addtodo.setCheckable(False)
        self.addtodo.setObjectName("addtodo")
        self.horizontalLayout_2.addWidget(self.addtodo)
