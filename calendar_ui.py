...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dateEdit.setCurrentSection(QtWidgets.QDateTimeEdit.NoSection)
        ...
        self.horizontalLayout_2.setContentsMargins(0, 0, 150, 0)
        ...
        self.horizontalLayout_3.setContentsMargins(0, 0, 274, 0)
        ...
        self.checkBox.toggled['bool'].connect(self.dateEdit.setDisabled)
    ...
    def retranslateUi(self, Form):
        ...
        self.dateEdit.setDisplayFormat(_translate("Form", "开始:  yyyy年M月d日"))
